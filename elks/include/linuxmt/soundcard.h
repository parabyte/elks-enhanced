...
/*
 * ELKS passes ioctl command numbers through a 16-bit int. Keep the low OSS
 * command word stable while computing the Linux direction/size fields wide
 * enough to avoid IA16 shift-width warnings.
 */
