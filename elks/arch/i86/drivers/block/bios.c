...
struct drive_infot fd_types[] = {   /* AT/PS2 BIOS reported floppy formats*/
    {40,  9, 2, 512, 0, 0, 0, 0},   /* 360k */
    {80, 15, 2, 512, 1, 0, 0, 0},   /* 1.2M */
    {80,  9, 2, 512, 2, 0, 0, 0},   /* 720k */
    {80, 18, 2, 512, 3, 0, 0, 0},   /* 1.4M */
    {80, 36, 2, 512, 4, 0, 0, 0},   /* 2.88M */
    {80, 36, 2, 512, 5, 0, 0, 0},   /* 2.88M */
    {77,  8, 2, 1024,6, 0, 0, 0},   /* 1.232M PC/98 only */
};
