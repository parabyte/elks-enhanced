...
struct msdos_devdir_entry devnods[DEVDIR_SIZE] = {
    ...
    { "cfa",	S_IFBLK | 0644, DEV_CFA                     },
    { "cfa1",	S_IFBLK | 0644, DEV_CFA+1                   },
    { "cfa2",	S_IFBLK | 0644, DEV_CFA+2                   },
    { "cfa3",	S_IFBLK | 0644, DEV_CFA+3                   },
    { "cfa4",	S_IFBLK | 0644, DEV_CFA+4                   },
    ...
    { "netdev",	S_IFCHR | 0644, MKDEV(NETDEV_MAJOR, 0)      },
