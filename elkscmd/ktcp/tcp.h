...
/*
 * /dev/netdev max read/write size
 * must be at least as big as CB_NORMAL_BUFSIZ
 * and at least as big as NETDEV_INBUFFERSIZE in <linuxmt/netdev.h> (currently 1500)
 */
#define TCPDEV_BUFSIZ	(CB_NORMAL_BUFSIZ + sizeof(struct ndb_return_data))
...
/* timeout values - unit is set by 'Now' in uip_main.c, currently 60ms */
